# Retail-Customer-Retention-Analytics- Using Power BI
# Objective :
  Develop an interactive Customer Retention Analytics Dashboard in Power BI using Target’s customer data: 
...
Power BI 
# Dataset:
Customer_Demographics.csv, Customer_Transactions.csv, Store_Locations.csv, Loyalty_Program.csv,  Churn_Labelled_Customers.csv
# Tasks Performed
